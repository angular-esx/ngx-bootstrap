...
function _ngxDomPortalHostClass() {
  ...
  this.attachComponentPortal = function(portal) {
    if (ngx.isNull(portal.viewContainerRef)) {
  ...
  this.attachTemplatePortal = function(portal) {
    ...
    ngx.forEach(_viewRef.rootNodes, function(rootNode) {
  ...
  this.destroy = function () {
    if (!ngx.isNull(this.hostElement.parentNode)) {
...
module.exports = {
  ...
  domPortalHostClass: ng.core.Class(new _ngxDomPortalHostClass())
};