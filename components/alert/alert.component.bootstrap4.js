...
module.exports = ng.core.Component({
  ...
  styles: [':host(.ngx-alert) hr { height: 0; border-width: 0 0 0 0; border-top-width: 1px; border-style: solid; box-sizing: content-box; } :host(.ngx-alert) a { text-decoration: none; background-color: transparent; cursor: pointer; } :host(.ngx-alert) a:focus, :host(.ngx-alert) a:hover, :host(.ngx-alert) a:active { outline: 0; } :host(.ngx-alert) { display: block; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; margin: 0 0 1rem 0; padding: 1rem; border: 1px solid transparent; border-radius: 0.25rem; } :host(.ngx-alert) a { text-decoration: underline; } :host(.ngx-alert) > p, :host(.ngx-alert) > ul { margin-bottom: 0; } :host(.ngx-alert) > p + p { margin-top: 5px; } :host(.ngx-alert).ngx-alert-state-hidden { display: none !important; } :host(.ngx-alert).ngx-alert-type-float { width: 100%; margin: 0; position: fixed; left: 0; box-sizing: border-box; } :host(.ngx-alert).ngx-alert-position-top { top: 0; } :host(.ngx-alert).ngx-alert-position-bottom { bottom: 0; } :host(.ngx-alert).ngx-alert-type-dismissible { padding: 1rem 2rem 1rem 1rem; } :host(.ngx-alert) > .ngx-alert-dismiss { font-size: 1.5rem; font-weight: 700; line-height: 1; text-shadow: 0 1px 0 #fff; color: #646a71; background: transparent; padding: 0; border: 0; opacity: .2; position: relative; float: right; top: -2px; right: -21px; text-decoration: none; cursor: pointer; -webkit-appearance: none; } :host(.ngx-alert) > .ngx-alert-dismiss :focus, :host(.ngx-alert) > .ngx-alert-dismiss:hover { opacity: .5; } :host(.ngx-alert).ngx-alert-color-info { color: #60c2df; background-color: rgba(96, 194, 223, 0.2); border-color: rgba(96, 194, 223, 0.3); } :host(.ngx-alert).ngx-alert-color-info hr { border-top-color: #60c2df; } :host(.ngx-alert).ngx-alert-color-info .ngx-alert-link, :host(.ngx-alert).ngx-alert-color-info .ngx-alert-link a { font-weight: bold; color: #60c2df; } :host(.ngx-alert).ngx-alert-color-success { color: #5cb85c; background-color: rgba(92, 184, 92, 0.2); border-color: rgba(92, 184, 92, 0.3); } :host(.ngx-alert).ngx-alert-color-success hr { border-top-color: #5cb85c; } :host(.ngx-alert).ngx-alert-color-success .ngx-alert-link, :host(.ngx-alert).ngx-alert-color-success .ngx-alert-link a { font-weight: bold; color: #5cb85c; } :host(.ngx-alert).ngx-alert-color-warning { color: #f0ad4e; background-color: rgba(240, 173, 78, 0.2); border-color: rgba(240, 173, 78, 0.3); } :host(.ngx-alert).ngx-alert-color-warning hr { border-top-color: #f0ad4e; } :host(.ngx-alert).ngx-alert-color-warning .ngx-alert-link, :host(.ngx-alert).ngx-alert-color-warning .ngx-alert-link a { font-weight: bold; color: #f0ad4e; } :host(.ngx-alert).ngx-alert-color-danger { color: #da5350; background-color: rgba(218, 83, 80, 0.2); border-color: rgba(218, 83, 80, 0.3); } :host(.ngx-alert).ngx-alert-color-danger hr { border-top-color: #da5350; } :host(.ngx-alert).ngx-alert-color-danger .ngx-alert-link, :host(.ngx-alert).ngx-alert-color-danger .ngx-alert-link a { font-weight: bold; color: #da5350; } '],
