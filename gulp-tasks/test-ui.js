module.exports = function (params) {
  return function () {
    ...
    return _gulp.src(_fileService.FILES.INDEX_HTML)
            ...
            .pipe(_inject(_streamSeries(_es6ShimJs, _rxJs, _angularPolyfillJs, _angularJs, _ngxBootstrapCss, _ngxBootstrapJs, _ngxBootstrapUtilsJs, _bootstrapCss), { relative: true, name: 'core' }))
