...
module.exports = ng.core.Component({
  ...
  styles: [':host(.ngx-breadcrumb) a { text-decoration: none; background-color: transparent; cursor: pointer; } :host(.ngx-breadcrumb) a:focus, :host(.ngx-breadcrumb) a:hover, :host(.ngx-breadcrumb) a:active { outline: 0; } :host(.ngx-breadcrumb) { display: block; padding: 0.75rem 1rem; margin: 0 0 1rem 0; background-color: transparent; } :host(.ngx-breadcrumb)::after { content: ""; display: table; clear: both; } :host(.ngx-breadcrumb) > .ngx-breadcrumb-item { float: left; } :host(.ngx-breadcrumb) > .ngx-breadcrumb-item:not(:last-child)::after { text-decoration: none; padding: 0 0.5rem 0 0.5rem; content: "/"; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-primary { background-color: #0270d2; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-primary > .ngx-breadcrumb-item, :host(.ngx-breadcrumb).ngx-breadcrumb-color-primary > .ngx-breadcrumb-item a, :host(.ngx-breadcrumb).ngx-breadcrumb-color-primary > a.ngx-breadcrumb-item { color: white; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-secondary { background-color: rgba(165, 171, 175, 0.5); } :host(.ngx-breadcrumb).ngx-breadcrumb-color-secondary > .ngx-breadcrumb-item, :host(.ngx-breadcrumb).ngx-breadcrumb-color-secondary > .ngx-breadcrumb-item a, :host(.ngx-breadcrumb).ngx-breadcrumb-color-secondary > a.ngx-breadcrumb-item { color: #646a71; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-info { background-color: #60c2df; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-info > .ngx-breadcrumb-item, :host(.ngx-breadcrumb).ngx-breadcrumb-color-info > .ngx-breadcrumb-item a, :host(.ngx-breadcrumb).ngx-breadcrumb-color-info > a.ngx-breadcrumb-item { color: white; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-success { background-color: #5cb85c; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-success > .ngx-breadcrumb-item, :host(.ngx-breadcrumb).ngx-breadcrumb-color-success > .ngx-breadcrumb-item a, :host(.ngx-breadcrumb).ngx-breadcrumb-color-success > a.ngx-breadcrumb-item { color: white; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-warning { background-color: #f0ad4e; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-warning > .ngx-breadcrumb-item, :host(.ngx-breadcrumb).ngx-breadcrumb-color-warning > .ngx-breadcrumb-item a, :host(.ngx-breadcrumb).ngx-breadcrumb-color-warning > a.ngx-breadcrumb-item { color: white; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-danger { background-color: #da5350; } :host(.ngx-breadcrumb).ngx-breadcrumb-color-danger > .ngx-breadcrumb-item, :host(.ngx-breadcrumb).ngx-breadcrumb-color-danger > .ngx-breadcrumb-item a, :host(.ngx-breadcrumb).ngx-breadcrumb-color-danger > a.ngx-breadcrumb-item { color: white; } '],
